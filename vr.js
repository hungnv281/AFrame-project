...
document.addEventListener("DOMContentLoaded", () => {
  const images360 = ["tang2-1", "sanh-c1", "sanh-c1-c2","love_street","library"];
  ...
  const clickBtnPause = () => {
    if (isPauseRotation) {
      vrCamera.setAttribute("animation", "property: rotation; to: 0 360 0; loop: true; dur: 20000");
    } else {
  ...
  document.querySelector("#infor-sanh-c1-new").addEventListener("click", () => {
    ...
    aText.setAttribute(
      "value",
      "Gajasimha có đầu voi và mình sư tử. Trong thần thoại Ấn Độ, đầu voi thường biểu trưng cho sự thông thái và quyền năng của thần linh và mình sư tử thể hiện vương quyền của nhà vua. Các tượng Gajasimha kích thước lớn được đặt trước các điện thờ, đóng vai trò như các linh vật gác cửa. Tác phẩm thể hiện đầu voi ngẩng cao, cổ đeo vòng lục lạc, mình có lông ngực được cách điệu bằng các đường kẻ sọc thường thấy trên các tượng linh vật thời kì Tháp Mẫm. Linh vật này là đề tài nổi bật và được thể hiện phổ biến trong nhiều tác phẩm điêu khắc Champa thời kì này."
    );
    aImage.setAttribute("src", "../asset/image/Toa-nha_C1.png");
    if (content.getAttribute("visible")) {
      aText.setAttribute(
        "value",
        "Lakshmi là vị thần của vận may, sức khỏe, sắc đẹp và thịnh vượng, vì thế người ta thờ cúng nàng để cầu mong có được phú quý, sung túc và giàu sang. Nàng là vợ của Vishnu, là mẹ của Kama - thần tình yêu, nhục cảm. Trong nghệ thuật Ấn Độ, Lakshmi thường được thể hiện qua hình tượng một phụ nữ xinh đẹp, có hai hoặc bốn tay, đứng hoặc ngồi trên một đóa hoa sen - biểu tượng của vẻ đẹp tinh thần thuần túy và tinh khiết. Theo truyền thuyết, nữ thần Lakshmi sinh ra từ biển Tượng LaKshm thường có lưng tựa vào giá đỡ hình cung tròn hai ngấn, từ đỉnh đầu xuống đến vai thắt lại thành hình chiếc lá đề, phần dưới vuốt xuôi cân đối dọc theo thân thể. Nét mặt nữ thần nghiêm trang, mắt khép hờ, chân mày giao nhau, tai dài nhưng không đeo trang sức, tóc búi cao hai tầng. Đôi tay Lakshmi buông theo thân mình, bên trái cầm chiếc lọ nhỏ, bên phải cầm búp sen non. Nữ thần mặc váy chấm đến cổ chân, để trơn, không trang trí."
      );
      aImage.setAttribute("src", "../asset/image/Toa-nha_C1.png");
    }
